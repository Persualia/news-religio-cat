"""Scraper implementation for https://www.iscreb.org/."""
...
class ISCREBScraper(BaseScraper):
    site_id = "iscreb"
    base_url = "https://www.iscreb.org"
    listing_url = "https://www.iscreb.org/ca/rss.xml"
    default_lang = "ca"
