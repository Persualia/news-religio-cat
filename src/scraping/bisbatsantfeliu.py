"""Scraper implementation for https://bisbatsantfeliu.cat/."""
...
class BisbatSantFeliuScraper(BaseScraper):
    site_id = "bisbatsantfeliu"
    base_url = "https://bisbatsantfeliu.cat"
    listing_url = (
        "https://bisbatsantfeliu.cat/wp-json/wp/v2/posts"
