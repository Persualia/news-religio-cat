"""Scraper implementation for http://www.adoratrius.cat/."""
...
class AdoratriusScraper(BaseScraper):
    site_id = "adoratrius"
    base_url = "http://www.adoratrius.cat"
    listing_url = "http://www.adoratrius.cat/feed/"
    default_lang = "ca"
