"""Scraper implementation for https://audir.org/noticies/."""
...
class AudirScraper(BaseScraper):
    site_id = "audir"
    base_url = "https://audir.org"
    listing_url = "https://audir.org/noticies/feed/"
    default_lang = "ca"
