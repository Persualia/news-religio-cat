"""Scraper implementation for https://diocesanaterrassa.caritas.es/."""
...
class CaritasTerrassaScraper(BaseScraper):
    site_id = "caritasterrassa"
    base_url = "https://diocesanaterrassa.caritas.es"
    listing_url = "https://diocesanaterrassa.caritas.es/es/feed/"
    default_lang = "es"
    ...
    def extract_items(self, listing_soup: BeautifulSoup) -> Iterable[NewsItem]:
        ...
        for entry in listing_soup.select("item"):
            ...
            published_at = parse_rfc822_datetime(extract_text(entry.select_one("pubDate")))
...
__all__ = ["CaritasTerrassaScraper"]
