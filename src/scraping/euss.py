"""Scraper implementation for https://neussletter.4veuss.com/."""
...
class EUSSScraper(BaseScraper):
    site_id = "euss"
    base_url = "https://neussletter.4veuss.com"
    listing_url = "https://neussletter.4veuss.com/feed/"
    default_lang = "ca"
